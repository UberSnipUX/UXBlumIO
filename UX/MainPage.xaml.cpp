...
#define KEENIO_PROJECT_ID ""
#define KEENIO_SDK_DEF 1
...
MainPage::MainPage()
{
	...
	if (dynamic_cast<Platform::String^>(APP_SETTINGS::ReadProperty(".launch")) == nullptr) {
		APP_SETTINGS::WriteProperty(".launch", "1");
		this->sendKeenIOProperty(KEENIO_PROJECT_ID, "APP_EVENT", "APP.INSTALL");
	}
	else {
		this->sendKeenIOProperty(KEENIO_PROJECT_ID, "APP_EVENT", "APP.LAUNCH");
	}
...
void UberSnipApp::MainPage::sendKeenIOProperty(string proj_id, string prop, string val) {
	...
	kCLIENT->kHTTP.addParam("api_key", kCLIENT->kHTTP.masterKey());
...
void UberSnipApp::MainPage::siteLogin(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	if (err >= 0) {
		...
		this->sendKeenIOProperty(KEENIO_PROJECT_ID, "APP_EVENT", "LOGGIN.SUCCESS");
		...
		this->sendKeenIOProperty(KEENIO_PROJECT_ID, "APP_EVENT", "LOGIN.FAILURE");
		//activeTrackTitle->Text = "Authenticated!";
...
void UberSnipApp::MainPage::listView_SelectionChanged_1(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
	...
	this->sendKeenIOProperty(KEENIO_PROJECT_ID, "APP_EVENT_CAT_VIEW", STRING_UTILS::StringToAscIIChars(url));
